...
//       <h4 className="mb-3 text-center">Track Your Ticket</h4>
...
//       {formData && (
//         <div className="card p-3 shadow-sm border border-secondary">
//           <h5 className="card-title text-secondary  text-center ">Ticket Details</h5>
